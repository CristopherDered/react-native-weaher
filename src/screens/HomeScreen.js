...
export default function HomeScreen() {
  ...
  return (
    ...
    <View className="flex-1 relative bg-[#17202a]">
          ...
          <SafeAreaView className="flex flex-1 pt-10">
            ...
            <View className="mx-4 flex justify-around flex-1 mb-1 ">
              ...
              <View className="space-y-2">
                <Text className="text-center font-semibold text-white text-6xl ml-5">
                  {current?.temp_c}&#176;
                </Text>
              ...
              {/*forecast section */}
              <View className="flex-row justify-between mx-4 p-6 rounded-3xl bg-[#616a6b]">
